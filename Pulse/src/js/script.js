...
$(document).ready(function () {
    ...
    $('.modal__close').on('click', function () {
        $('.overlay, #consultation, #thanks, #oreder').fadeOut(700);
    });
    ...
    $('.modal__close').on('click', function () {
        $('.overlay, #order, #thanks').fadeOut(700);
    });
    ...
    $('#order input[name=phone]').click(function () {
        if ($('#order input[name=phone]').val() == "+7(___)___-__-__") {
            $(this)[0].selectionStart = 3;
            $(this)[0].selectionEnd = 3;
        }
    });

    $('#consultation input[name=phone]').click(function () {
        if ($('#consultation input[name=phone]').val() == "+7(___)___-__-__") {
            $(this)[0].selectionStart = 3;
            $(this)[0].selectionEnd = 3;
        }
    });
    ...
    $('#form input[name=phone]').click(function () {
        if ($('#form input[name=phone]').val() == "+7(___)___-__-__") {
            $(this)[0].selectionStart = 3;
            $(this)[0].selectionEnd = 3;
        }
    });
